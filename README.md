...
We observed that when four 1.5 V of battery is connected in series connection, the multimeter showed overall volatgae of 6 V.
Hence,when the batteries are connected in series,the overall volatge across the circuit is the sun of the voltage of the batteries.
...
We observed that when four 1.5 V of battery is connected in parallel connection, the multimeter showed overall voltage of 1.5 V.
Hence, when the batteries are connected in series, the overall voltage across the circuit remains same.
...
a.	R2: ______1.4__________ V: _____________1mv    Measured Voltage: __________583______

b.	R2: ___________1.5_____ V: _________2mv____    Measured Voltage: _______1.3_________

c.	R2: __________2______ V: __________1mv___    Measured Voltage: __________666mv ______
